...
def conserved_to_primitive(U_1D, gamma_val):
    """
...
def primitive_to_conserved(rho, u, p, gamma_val):
    """
...
def calculate_flux(U_1D, gamma_val):
    """
    ...
    rho, u, p = conserved_to_primitive(U_1D, gamma_val)
